...
const std::unordered_map<unsigned, const char *> logbookViewedDesc = {
    {0, "Destroy the Boulder!"},
    {1, "Guardian Sapling Trouble"},
    {2, "Secret of Hana Valley"},
    {3, "Revive the Guardian Saplings"},
    {4, "Sacred Tree Reborn"},
    {5, "Shinshu Adventure"},
    {6, "Heavy Sleeper"},
    {7, "Make the Trees Bloom"},
    {8, "Mr. Orange's Dance"},
    {9, "Have Water Lily, Will Travel"},
    {10, "Sapling of Agata Forest"},
    {11, "Hard Working Son"},
    {12, "Ume is Lost"},
    {13, "The Lost Key"},
    {14, "A Son's Determination"},
    {15, "Mysterious Windmill"},
    {16, "Divine Wind's Cessation"},
    {17, "Canine Warrior Hunt"},
    {18, "Remaining Warriors"},
    {19, "Animal Hating Couple"},
    {20, "Rejection"},
    {21, "Spring No More"},
    {22, "Blocked Path"},
    {23, "Ume's Lost Again"},
    {24, "Kushi's Distress"},
    {25, "Ume the Meal"},
    {26, "Fight With Hayabusa"},
    {27, "Digging Record"},
    {28, "Orbs Reunited"},
    {29, "Defeat Crimson Helm!"},
    {30, "Powerful Brew"},
    {31, "Kushi's Decision"},
    {32, "Kushi's Feelings"},
    {33, "Festival"},
    {34, "To the Capital!"},
    {35, "City Checkpoint"},
    {36, "Bringing Down the Bridge"},
    {37, "Capital Under Misty Siege"},
    {38, "Himiko, Queen of Nippon"},
    {39, "Watery Wants"},
    {40, "Fishing for Trouble"},
    {41, "Living Sword"},
    {42, "Fox Rods"},
    {43, "Sunken Treasure"},
    {44, "Tight Security"},
    ...
    {47, "Kaguya's Lament"},
    {48, "Himiko's Motive"},
    {49, "Land of the Dragonians"},
    {50, "Emissary From the Deep"},
    {51, "The Amazing Orca"},
    {52, "Otohime's Test"},
    {53, "Into the Dragon"},
    {54, "Fox Rods"},
    {55, "Wada's Request"},
    {56, "Bad Feeling Confirmed"},
    {57, "Oni Island's Whereabouts"},
    {58, "Lone Wolf vs Evil"},
    {59, "Shinshu's Rolling Thunder"},
    {60, "Subzero Zone"},
    {61, "Cold Comfort"},
    {62, "Squatters of Ezofuji"},
    {63, "Icy Wep'keer"},
    {64, "Lika is Missing!"},
    {65, "Forest of Yoshpet"},
    {66, "Kai as Guide"},
    {67, "Kai Goes Deep"},
    {68, "Poncle Village Ponc'tan"},
    {69, "Gate of Misfortune"},
    {70, "Open Wide the Spirit Gate"},
    {71, "Spirit Gate Ho!"},
    {72, "Beyond the Gate"},
    {73, "Kamiki a Century Ago"},
    {74, "To the Moon Cave!"},
    {75, "Enter Ishaku"},
    {76, "Take Lika to Ezofuji"},
    {77, ""},
    {78, "Oki's Unauthorized Act"},
    {79, "Rising Yamato"},
    {80, "Yoichi the Philosopher"},
    {81, "Carpenter's Project"},
    {82, "Wanted: Prayer Slips"},
    {83, "A Suspicious Emperor"},
    {84, "Kaguya's Memories"},
    {85, "Catcall Tower"},
    {86, "The Power of Catwalk"},
    {87, "Twin Whirlpools"},
    {88, "Cut Down the Peach"},
    {89, "Orochi's Appetizer"},
};
...
const std::unordered_map<unsigned, MapDesc> mapDataDesc = {
    {0,
     {
         .worldStateBits =
             {
